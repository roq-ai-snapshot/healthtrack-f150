  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower Your Wellness Journey with HealthTrack: A Comprehensive Health and Fitness Tracking App to Achieve Goals, Monitor Progress, and Optimize Your Well-being."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              Empower Your Wellness Journey with HealthTrack: A Comprehensive Health and Fitness Tracking App to Achieve
              Goals, Monitor Progress, and Optimize Your Well-being.
            </Text>
            <Text>Founder</Text>
